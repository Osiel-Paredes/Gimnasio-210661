          ...
          <div class="border border-gray-300 rounded-lg p-6 max-w-md shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] max-md:mx-auto">
            <form class="space-y-4">
              <div class="mb-8">
                ...
                <p class="text-gray-500 text-sm mt-4 leading-relaxed">Inicie sesión en su cuenta y explore un mundo de posibilidades. Tu viaje comienza aquí..</p>
              </div>
              ...
              <p class="text-sm !mt-8 text-center text-gray-800">No tienes cuenta aún? <a href="javascript:void(0);" class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</a></p>
            </form>
          </div>
